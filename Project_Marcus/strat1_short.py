...
# -*- coding: utf-8 -*-
"""
Created on Fri May 20 01:15:10 2022
...
def strat1_short(price_primary, price_confirmation, i):
    macd_mean = price_primary['signal_line'].mean()
    macd_dev = price_primary['signal_line'].std()
    
    if(price_primary['SMA50'][i] < price_primary['Lower Band'][i] and price_primary['signal_line'][i] > price_primary['MACD_mean'][i]+1*price_primary['MACD_dev'][i]):
        # return True
